<?php 
	...
	$modificar=mysqli_query($link,"select * from vivienda where id='".$id."'");
	$total=mysqli_query($link,"slect * from vivienda");
	
	$vi=mysqli_fetch_assoc($modificar);
	if(!empty($_POST)){
...
<table>
	<tr>
		...
		<td>
			<select name='tipo'>
				...
				<option  selected="selected" value='depto'>Depto </option>
	...
	<tr>
		...
		<tr>
		<td>Direccion</td>
		<td> <input type='text' name='direccion' value='<?php echo $vi['direccion'];?>'></td>
