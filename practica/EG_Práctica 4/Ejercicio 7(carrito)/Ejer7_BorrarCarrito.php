<?php
	...
	/*Función unset borra el elemento de un array que le pasemos por parámetro. En este caso la usamos para borrar el elemento cuyo id le pasemos a la página por la url*/
